  ...
  const columns: ProColumns<API.HDF5ListItem>[] = [
    ...
    },
    {
      ...
      render: (_, entity) => [
        ...
        <a key="viewdetail"
          onClick={() => {
            // DUQUHDF5_001：修改跳转逻辑，传递文件名作为URL参数
            if (entity && entity.name) {
              window.open(`/slam-data-review?file=${encodeURIComponent(entity.name)}`, "popup", "width=1440,height=1280")
            } else {
              console.error("无法打开，因为文件名为空。", entity);
